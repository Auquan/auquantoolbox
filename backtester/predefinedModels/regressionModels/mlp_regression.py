...
class MultiLayerPerceptronRegression(Model):

    def __init__(self, params):
        super(MultiLayerPerceptronRegression, self).__init__(params)
        ...
        self._model = neural_network.MLPRegressor(hidden_layer_sizes = hidden_layer_sizes,
