...
class RatioMarketFeature(Feature):
    ...
    def computeForInstrument(cls, updateNum, time, featureParams, featureKey, instrumentManager):
        ...
        feature1 = instrumentLookbackData.getDataForFeatureForAllInstruments(featureParams['featureName1']).iloc[-1]
        feature2 = instrumentLookbackData.getDataForFeatureForAllInstruments(featureParams['featureName2']).iloc[-1]
    ...
    def computeForMarket(cls, updateNum, time, featureParams, featureKey, currentMarketFeatures, instrumentManager):
        ...
        if (instrument1 is None) or (instrument2 is None):
            ...
            instrumentLookbackData = instrumentManager.getLookbackInstrumentFeatures()
            dataDf = instrumentLookbackData.getDataForFeatureForAllInstruments(feature)
