...
######## the limitType is 'R'
        ...
        ###################################################
        results["getPriceSeries"]=pd.Series({'a':2.35,'b':0.25},name=seriesname)
        results["getLongLimit"]=pd.Series({'a':0.0,'b':0.0},name=seriesname)
        results["getShortLimit"]=pd.Series({'a':0.0,'b':0.0},name=seriesname)
        results["getEnterLotSize"]=pd.Series({'a':0.0,'b':0.0},name=seriesname)
        results["getExitLotSize"]=pd.Series({'a':0.0,'b':0.0},name=seriesname)
        results["convertLimit"]=pd.Series({'a':0.0,'b':0.0},name=seriesname)
        ###################################################
        dict=OrderedDict()
        dict["a"]=1
        dict["b"]=2
