...
#### logging IndexErrors
    if(c==0):
        ...
        ##############################################
        results["count_profit_Instrument"]=None
        results["count_profit_Market"]=None
#### data has nans and infs
    if(c==1):
        ...
        parameters["pnlKey"] = "pnlKey"
        ##############################################
        results["count_profit_Instrument"]=pd.Series({'a':1.0,'b':0.0})
        results["count_profit_Market"]=3.0
#### testing for sample data
    if(c==2):
        ...
        parameters["pnlKey"] = "pnlKey"
        ##############################################
        results["count_profit_Instrument"]=pd.Series({'a':1,'b':1,'c':1,'d':1,'e':0})
        results["count_profit_Market"]=1
    if(c==3):
        indexlist=  [pd.tslib.Timestamp('2017-01-03 09:30:30'),
        ...
        parameters["pnlKey"] = "pnlKey"
        ##############################################
        results["count_profit_Instrument"]=pd.Series({'a':2.35,'b':1.25})
        results["count_profit_Market"]=5.02
