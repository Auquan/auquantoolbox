...
#### data has nans and infs
    if(c==1):
        indexlist=[pd.Timestamp('2017-01-03 09:30:30'),pd.Timestamp('2017-01-03 10:30:30'),pd.Timestamp('2017-01-03 11:30:30')]
        ...
        parameters["price"] = "price"
        parameters["fees"] = "fees"
        parameters["initial_capital"] = 3.0
        ##############################################
        results["capital_Instrument"]=pd.Series({'a':0.0,'b':0.0})
        results["capital_Market"]=-np.inf
